...
admin=["u427d993df01778cd4edf5cd8c3f012ac"]
wait = {
    'contact':True,
    'autoJoin':True,
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes BOG")
                                ki.sendText(msg.to,"Succes BOG")
                                kk.sendText(msg.to,"Succes BOG")
                                kc.sendText(msg.to,"Succes BOG")
                            except:
                                ki.sendText(msg.to,"Succes Cv")
                                kk.sendText(msg.to,"Succes Cv")
                                kc.sendText(msg.to,"Succes Cv")
